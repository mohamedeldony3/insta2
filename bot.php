...
$fackfor = "You are coming to change the rights, be men and be safe\n";
    $fackfor2 = "تم تفعيل البوت   ) done";
    echo $fackfor;
    echo $fackfor2;
		...
		if($update != null){
          ...
          $accounts = json_decode(file_get_contents('accounts.json'),1);
            ...
            $bot->sendMessage([
		       'chat_id'=>$chatId,
                'message_id'=>$mid,
                'text'=>"˹𝐑𝐀𝐌𝐎 ˼ 𓆪 . ↯ @Ramo44 ↯ @Ramo44 ↯ |",

              ]);   
              
           } if($text == '️ماهو بوت صيد والمتاحات💻'){ 
            $bot->sendMessage([
         'chat_id'=>$chatId,
                'message_id'=>$mid,
...
",
              ...
              } if($text == '️تطبيق توصيل الريست🔄'){
                  $bot->sendphoto([ 
                  'chat_id'=>$chatId,                  'photo'=>"https://t.me/yffhfhchhf/890",
				  'caption'=>'برنامج توصيل الريست 🌝
https://t.me/yffhfhchhf/891',
              ]);
          	...
          	if($config['mode'] != null){
                ...
                'reply_markup'=>json_encode([
					...
					$bot->sendphoto([
       'chat_id'=>$chatId,
       'photo'=> "https://t.me/Ramo44",
        'caption'=>'البوت مدفوع 💲 و ليس مجاني 👁‍🗨
لشراء نسخه مراسلة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'مراسله المطور 🐆🔥','url'=>'t.me/Ramo44']],
                       [['text'=>"قناه المطور 💻", 'url'=>"t.me/Remove44"]],
                  ]
							])
					]);
				}
